...
class Point(object):
    ...
    def move_to(self, x, y):
        self.distance_x = self.distance_x + (x - self.x)
        self.distance_y = self.distance_y + (y - self.y)
        self.x = x
        self.y = y
        self.count = self.count + 1

    def move_by(self, dx, dy):
        self.distance_x = self.distance_x + dx
        self.distance_y = self.distance_y + dy
        self.x = self.x + dx
        self.y = self.y + dy
        self.count = self.count + 1
    ...
    def get_distance_from_start(self):
        get_distance_from_start = math.sqrt((self.distance_x ** 2) + (self.distance_y ** 2))
        return get_distance_from_start
    ...
    def closer_to(self, p2, p3):
        distance_point = math.sqrt((p2.x ** 2) + (p2.y ** 2))
        distance_point1 = math.sqrt((p3.x ** 2) + (p3.y ** 2))
...
def run_test_move_to():
    ...
    """
    # --------------------------------------------------------------------------
    # COMPLETED: 6.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_by():
    ...
    You may also use this example to test this method.
        ...
        """
    # --------------------------------------------------------------------------
    # COMPLETED: 7.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # --------------------------------------------------------------------------
    # COMPLETED: 8.  Follow the same instructions as in _TODO_ 3 above,
    #    but for the  get_number_of_moves_made  method specified above.
    # COMPLETED (continued):  HINT: What must a Point REMEMBER for this method?
    # --------------------------------------------------------------------------
    print()
    print('-----------------------------------------------------------')
...
def run_test_get_distance_from_start():
    ...
    """
    # --------------------------------------------------------------------------
    # COMPLETED: 10.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # --------------------------------------------------------------------------
    # COMPLETED: 11.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_closer_to():
    ...
    """
    # --------------------------------------------------------------------------
    # COMPLETED: 12.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_halfway_to():
    ...
    """
    # --------------------------------------------------------------------------
    # COMPLETED: 13.  Follow the same instructions as in TO-DO 3 above,
